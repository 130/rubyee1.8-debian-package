...
testrbee1.8 - Automatic runnter for Test::Unit of Ruby

= SYNOPSIS

testrbee1.8 [options] [-- untouched arguments] test ...

= DESCRIPTION

testrbee1.8 loads and runs unit-tests.  If test is directory name, testrbee1.8
testrbee1.8 traverses the directory.
